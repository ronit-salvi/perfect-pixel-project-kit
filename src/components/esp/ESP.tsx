...
const ESP: React.FC = () => {
  ...
  const handleProceed = () => {
    console.log("Proceeding to success page");
    ...
    <div className="bg-gray-50 max-w-[480px] w-full h-[812px] overflow-y-auto mx-auto">
      <div className="flex flex-col bg-white">
        ...
        <main className="flex flex-col flex-1 justify-center p-4 w-full">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/455f743bc1c9461cac1bab4c6df6f995/f8e8f3283d7969c06675aafff542c79647e5a10f?placeholderIfAbsent=true"
